...
const FRAME_TYPES = ['new_message', 'edit_message', 'delete_message', 'pin_message', 'read', 'media_read', 'chat_removed', 'typing', 'presence', 'reaction', 'draft_update', 'dialog_pin', 'dialog_archive', 'message_ack', 'message_error', 'pong', 'call_request', 'call_accept', 'call_decline', 'call_end', 'call_signal']
