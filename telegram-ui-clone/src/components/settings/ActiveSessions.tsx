...
const OTHERS: Sess[] = [
  { id: 's1', icon: <PhoneIphoneRounded />, app: 'Telegram iOS 10.2', device: 'iPhone 15 Pro', loc: 'Almaty, Kazakhstan', last: '2 hours ago' },
  { id: 's2', icon: <DesktopWindowsRounded />, app: 'Telegram Desktop', device: 'Windows 11', loc: 'Astana, Kazakhstan', last: 'Jun 18' },
  { id: 's3', icon: <PhoneAndroidRounded />, app: 'Telegram Android', device: 'Pixel 8', loc: 'Almaty, Kazakhstan', last: 'Jun 12' },
]
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
          ...
          {current ? (
            ...
            <CloseRounded
              ...
              sx={{ fontSize: 20, color: tg.textFaint, cursor: 'pointer', '&:hover': { color: '#ff595a' } }}
            />
          )}
        </Box>
  ...
  return (
    <SettingsScreen title="Active Sessions" onBack={onBack}>
      <Section caption="This device">
        {sessionRow(
          { id: 'cur', icon: <LaptopMacRounded />, app: 'Telegram Web', device: 'Chrome · macOS', loc: 'Almaty, Kazakhstan', last: '' },
          true,
        )}
      </Section>
