...
func newTestRouter(t *testing.T) http.Handler {
	...
	return NewRouter(newAuthUC(pool), newChatUC(pool), nil, nil, nil, nil, nil, nil, NewICEHandler("", "test"))
}
...
func TestQRLoginFlow_HTTP(t *testing.T) {
	...
	h := NewRouter(uc, newChatUC(pool), nil, nil, nil, nil, nil, nil, NewICEHandler("", "test"))
