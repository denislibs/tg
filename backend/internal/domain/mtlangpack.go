...
// переводы НЕПОЛНЫЕ (у русского переведено 1170 ключей из 1254, у остальных
// четырёх — около 674), так что база у них действительно английский, и поле
// говорит правду.
//
...
// реализовано — `getLangPack('ru')` отдаёт ровно 1170 строк русского, а не
// 1254 с английскими заплатками. Сегодня дыры не видно, потому что наш клиент
// везёт свой английский словарь и кладёт перевод поверх него. Она откроется в
// задаче 5 или 9, если клиент перестанет везти английский бандл: 84 ключа у
// русского и около 580 у каждого из остальных приедут на экран сырыми
// символическими ключами. Закрывать её — либо подмешиванием на сервере, либо
// сохранением локального словаря у клиента; решение за задачей 5.
//
