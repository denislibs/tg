...
const ru = {
  ...
  Online: 'в сети',
  OnlineCount: {
    one_value: '%1$d онлайн',
    few_value: '%1$d онлайн',
    many_value: '%1$d онлайн',
    other_value: '%1$d онлайн',
  },
  ...
  // ни к одному аккаунту» (`Login.Passkey.Error.NotFound`, :37) у нас нет —
  // бэкенд отвечает одним 401 на любой отказ, различать нечем.
  ...
  // Футер комментариев под постом канала — ключи ОРИГИНАЛА
  // (`chat/replies.ts:94-98`): счётчик и «оставьте комментарий» на нуле.
  Comments: {
    one_value: '%1$d комментарий',
    few_value: '%1$d комментария',
    many_value: '%1$d комментариев',
    other_value: '%1$d комментария',
  },
