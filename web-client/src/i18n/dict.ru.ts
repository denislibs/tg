...
const ru = {
  ...
  'Chat.Accessory.Forward.One': 'Переслать сообщение',
  'Chat.Accessory.Forward.Hidden': 'Переслать сообщение (без имени)',
  'Chat.Accessory.Forward.Many': 'Переслать сообщения',
