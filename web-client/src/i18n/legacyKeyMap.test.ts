...
describe('карта миграции ключей', () => {
  ...
  const NEW_WITHOUT_LEGACY = [
    ...
    'Hours',
    // Задача 8. Самоназвание языка: раньше имена языков лежали таблицей на
    // экране (`i18n/index.tsx::LANGS`), а не в словаре, — старой СТРОКИ у этого
    // ключа не было ни одной.
    'LanguageName',
  ]
