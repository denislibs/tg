...
// может отсутствовать — и тогда `t()` молча отдаёт английский текст: под серверным
// пакетом всегда лежит локальный английский (`I18n.applyServerLangPack`), и
// непереведённый ключ падает на него. Ни тайпчек, ни скан старых ключей этого не
// видят: ключ настоящий, вызов правильный, текст английский.
//
