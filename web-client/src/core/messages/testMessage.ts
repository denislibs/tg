...
export function makeRawMessage(f: MessageFixture): RawMessageReal {
  ...
  // Приведение осталось ровно из-за ПРОСТРАНСТВА НОМЕРОВ: у модели номера
  // клиентские, у провода серверные, и типы это различают. Ни вложение, ни
  // агрегат реакций приводить больше не надо — их форма совпала с проводом.
