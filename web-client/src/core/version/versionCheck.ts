...
// (location.reload()) рисует App. Cache-bust — на хешах ассетов: оболочку
// (`index.html`) service worker не кэширует вовсе, как и оригинал
// (`serviceWorker/index.service.ts:274` — навигация под гейт кэша не подпадает),
// поэтому перезагрузка всегда получает свежую разметку со свежими хешами.
