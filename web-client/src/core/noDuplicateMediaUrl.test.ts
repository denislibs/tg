...
const ALLOWED = [
  ...
  // запись, а не «ещё один потребитель»: React-хук уйдёт вместе с React-лентой
  // (этап 7 порта), и тогда писателей опять станет двое. Пока их трое, и это
  // ровно два канала доставки одного снимка × две реализации ленты, живущие под
  // взаимоисключающим флагом VITE_VANILLA_FEED, — а не N независимых писателей.
