...
interface PeersState {
  ...
  /** Влить карточки (операция upsert: ответ /users, подъём из офлайн-стора).
   * Пишет только изменившиеся — ref окна пира стабилен, если данные те же
   * (мемоизированные потребители не перерисуются). */
