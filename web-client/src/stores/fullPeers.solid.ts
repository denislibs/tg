 ...
 * `useUserProfileData.ts::useUserProfile` (React, жил в `UserInfoPanel.tsx`,
 * снесён задачей 6 — потребителя не осталось, см. её докблок на месте хука)
 ...
 * (`saveProfilePhone`, ниже), а читает готовое `peerProfile.solid.tsx::Phone`
 * (Task 4, пришла на место `useUserProfile`) — сеть зовёт ТОЛЬКО эта функция,
 * для ОБОИХ фреймворков.
 *
