...
export type LottieOptions = {
  ...
  color?: LottieColor,
  // tweb: WrapSomethingOptions['textColor'] (accessor цвета текста для тинта custom-emoji);
  // островок не тянет глобальные типы tweb — конкретный срез: строка или accessor.
