...
// Минимальный срез tweb ThreadedWorkerEvents: одноворкерной схеме нужно только
// событие рукопожатия 'port' (пул воркеров/createProxyWorkerURLs и MTProto-прокси
// не переносим).
type ThreadedWorkerEvents = {
