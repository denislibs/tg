...
// общего с сортированным списком у него ничего нет); у нас он портирован
// раньше списка и лежит отдельным файлом под тем же именем класса, а
// `SortedList` (`helpers/sortedList.ts`) его отсюда импортирует.
//
