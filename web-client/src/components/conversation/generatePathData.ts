// Порт tweb `src/helpers/generatePathData.ts` 1:1 (без MOUNT_CLASS_TO).
// Строит `d` прямоугольника со скруглениями, начиная с середины верхней стороны —
// именно с этой точки у tweb «бежит» пунктир рамки drop-зоны (stroke-dasharray +
// анимация stroke-dashoffset в `_chatDrop.scss`).
