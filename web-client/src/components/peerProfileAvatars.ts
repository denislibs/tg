...
//    статус там ЕСТЬ (Task 3 порта карточки профиля на Solid кладёт их в этот
//    узел мостом `mountSolid` — `peerProfile.solid.tsx`, компонент
//    `PeerProfile`, см. докблок поля `info` выше: единственный писатель узла
//    сегодня — Solid, НЕ React; было — React-портал до этой задачи, находка
//    ревью «Что НЕ портировано»-блок устарел вместе со сменой владельца),
//    просто без этой конкретной покраски. Строка не вызывается, а не заглушена.
