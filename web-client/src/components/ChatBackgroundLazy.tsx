...
// Обои чата тянут свой canvas-рендер паттерна + дудл-ассет — не нужны до первого
// кадра. Грузим лениво отдельным чанком, вон из главного бандла; App и AuthFlow
// используют эту обёртку, деля один и тот же чанк.
