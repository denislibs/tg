...
// Снесённая React-лента пересчитывала группировку ЦЕЛИКОМ на каждом рендере:
// собирала прогоны альбомов, звала `groupBreak(i-1, i)` для каждого бабла и
// заново строила секции дней. Пришло одно сообщение — прошли по всем сорока.
//
