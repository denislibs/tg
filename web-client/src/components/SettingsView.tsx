...
export default function SettingsView({
  ...
  // ШОВ С ПОРТОМ. Этот экран — наш временный корень настроек; в tweb его роль
  // играет вкладка того же слайдера (`AppSettingsTab`), поэтому там открывать
  // вкладки просто некому, кроме неё самой. Пока корень React'овый, слайдером
  // владеет он: заводит на монтировании и УНОСИТ С СОБОЙ на размонтировании —
  // иначе вкладка пережила бы свой экран (тот же класс дефекта, что попап,
  // переживший чат, в ревью волны 1). Пин — `settingsSliderHost.test.ts`.
