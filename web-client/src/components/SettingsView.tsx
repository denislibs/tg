...
export default function SettingsView({
  ...
  // над настройками проваливался в прежний фолбэк `escFallback` (снят задачей
  // chat-navigation-im-3, см. `core/hotkeys.ts`) — то есть ЗАКРЫВАЛ ЧАТ ПОД
  // НИМИ вместо самих настроек.
  //
