...
//
// ── Обезьянка (`TrackingMonkey`) — ЗАГЛУШКА, ЗАДАЧА #128 ────────────────────
...
// как ЗАДАЧА #128 (Solid-порт `monkeys/tracking.ts`, с нуля — прежний React-
// порт для референса смотреть в истории git, не в дереве). Ниже — статический
// `div.media-sticker-wrapper` того же контура, что у оригинала (`stickerHost`),
// без канв: вёрстка/размер шапки совпадают, анимации нет.
