...
// `Login.ResetPassword.Subtitle` (1:1 с tweb, НЕ трогает существующий
// `CodeHint` — тот всё ещё используется React-версией этой карточки) и
// подставлен аргументом `wrapEmailPattern(...)` напрямую — `i18n()`
