...
// Значение-объект — форма числа (`langPackStringPluralized`), форму выбирает `I18n.format`.
//
// ЭТОТ ФАЙЛ — НИЖНИЙ СЛОЙ ВСЕЙ ЛОКАЛИЗАЦИИ, а не запасной: `I18n.applyServerLangPack`
// кладёт его ПОД серверный пакет любого языка (`lib/langPack.ts`), поэтому ключ,
// которого нет в переводе, читается по-английски, а не своим именем. Он же — исходник
