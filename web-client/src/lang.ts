...
const lang = {
  ...
  // («can join») был выдуман и склеивался с числом в коде: суффикс печатался префиксом,
  // и по-русски выходило «могут вступить 5».
  CanJoin: {
  ...
  Hide: 'Hide',
  // Пара к `Days`/`Weeks`/`Months`/`Years`: срок ограничения участника считает часы
  // (tweb lang.ts:1675 — текст и формы взяты у оригинала дословно).
  Hours: {
    one_value: '%1$d hour',
