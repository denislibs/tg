...
`docs/research/tweb-dom/`. Там, где источник не найден, стоит явная пометка **«не найдено»** —
...
| `D/` | `/Users/denisurevic/Documents/messenger-denis/docs/research/tweb-dom/` |

Основные источники:

- `D/04-composer-rest.json` — полное дерево композера в покое + computed;
- `D/04-emoji-dropdown.json`, `D/04-attach-menu.json`;
- `docs/research/2026-08-08-tweb-live-dom-reference.md` §4;
